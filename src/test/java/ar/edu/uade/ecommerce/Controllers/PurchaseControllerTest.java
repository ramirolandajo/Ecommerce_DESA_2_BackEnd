...
//        ResponseEntity<Purchase> response = purchaseController.getPurchaseById(token, 1);
...
//        ResponseEntity<Purchase> response = purchaseController.confirmPurchase(token, 1);
//        assertEquals(200, response.getStatusCodeValue());
//        assertEquals(purchase, response.getBody());
//    }
//
...
//        String token = "Bearer testtoken";
//        when(purchaseService.getEmailFromToken("testtoken")).thenReturn(null);
//        ResponseEntity<List<Purchase>> response = purchaseController.getPurchasesByUser(token);
//        assertEquals(401, response.getStatusCodeValue());
//    }
//
//    @Test
